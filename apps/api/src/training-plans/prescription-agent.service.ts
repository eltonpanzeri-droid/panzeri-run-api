    ...
    return JSON.stringify(
      {
        ...
        metaDeProva: input.targetRace
          ? {
              ...
              primeiraVezNessaDistancia: input.targetRace.isFirstTimeAtDistance,
              oQuantoQuerMelhorarPerformance: input.targetRace.performanceIntent,
              oQuantoEhSobreCurtirAExperiencia: input.targetRace.socialIntent,
              oQuantoEhImportantePessoalmente: input.targetRace.personalImportance,
              oQuantoAchaQueVaiSerDificil: input.targetRace.perceivedDifficulty,
              oQuantoEstaDispostoASeDedicar: input.targetRace.dedicationWillingness,
              oQuantoConseguirVaiTrazerSatisfacao: input.targetRace.achievementSatisfaction,
              oQuantoConfiaQueVaiConseguir: input.targetRace.confidenceLevel,
              oQuantoTemePreocupacaoComLesao: input.targetRace.injuryConcern,
              oQuantoEstaAbertoAAjustarAMeta: input.targetRace.adjustmentOpenness,
              oQuantoSenteAnsiedade: input.targetRace.anxietyLevel,
            }
          : null,
      },
      null,
