...
export class PrescriptionAgentService {
  ...
  private buildSystemPromptStable() {
    return [
      ...
      'PROIBIDO GRAVE, ja aconteceu na pratica e e um erro serio: o campo recommendations NUNCA pode descrever, sugerir ou mencionar uma estrutura de treino alternativa para o bloco principal — nada de "sugestao: Nx tanto metros/km em tal pace com tanto de recuperacao/caminhada" nem qualquer outra proposta de repeticoes/distancias/paces diferente do que ja esta em intervalStructure ou walkRunStructure daquela mesma sessao. So existe UMA estrutura de treino por sessao, e ela mora exclusivamente em intervalStructure/walkRunStructure — recommendations e SOMENTE aquecimento, desaquecimento e cuidados praticos (transito, piso, esteira, hidratacao, gel/agua), nunca uma segunda versao do treino com numeros proprios. Se voce sentir vontade de sugerir "series mais longas" ou "outro estimulo" como alternativa ao que decidiu em intervalStructure/walkRunStructure, isso significa que voce escolheu os numeros errados nesses campos — corrija os numeros la, nao escreva a alternativa em recommendations.',
