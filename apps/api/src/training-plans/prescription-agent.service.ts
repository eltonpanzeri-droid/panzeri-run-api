...
export class PrescriptionAgentService {
  ...
  private buildSystemPromptStable() {
    return [
      ...
      'O campo notes e a sua voz de treinador falando com o aluno sobre aquele dia: os numeros (distancia/pace/series) + a conversa real (como executar, cuidados, o que fazer se sentir mais cansado) — sempre narrando a MESMA prescricao que esta em parts, nunca uma segunda versao diferente. Se o treino for 1 parte so, nao fale de aquecimento/resfriamento (ja e texto padrao fixo); se tiver 2+ partes com uma caminhada de 5+ min no inicio, esse texto padrao some sozinho e voce descreve cada parte.',
