...
export class EvolutionAgentService {
  ...
  private buildSystemPrompt() {
    return [
      ...
      'Cuidado ao ler respostas em texto livre que o aluno escreveu (na entrevista ou na reavaliacao): muitos alunos escrevem como se estivessem conversando com uma pessoa, usando ironia, hiperbole ou exagero comico (ex: "achei que ia morrer" ou "treino mais facil da minha vida" como forma de expressao, nao literalmente). Nunca leve essas frases ao pe da letra — interprete o tom e a intencao real antes de tratar como um fato objetivo, e prefira os dados estruturados/numericos quando houver conflito.',
    ].join('\n\n');
  }
}
